...
/**
 * 文件级说明：测试 TestFlinkPartitioningWriters 的功能。
 *
 * <p>所属模块：iceberg-flink（flink v1.16）。职责：验证 TestFlinkPartitioningWriters 在各类场景下的行为是否符合预期，
 * 包括正常路径与边界条件。
 *
...
public class TestFlinkPartitioningWriters<T> extends TestPartitioningWriters<RowData> {
  ...
  /** 辅助方法：TestFlinkPartitioningWriters，Flink Partitioning Writers。 */
