...
/**
 * 文件级说明：测试 TestIcebergBinaryObjectInspector 的功能。
 *
 * <p>所属模块：iceberg-mr。职责：验证 TestIcebergBinaryObjectInspector 在各类场景下的行为是否符合预期， 包括正常路径与边界条件。
 *
...
public class TestIcebergBinaryObjectInspector {
  ...
  /**
   * 测试场景：Iceberg Byte Buffer Object Inspector。
   *
   * <p>验证该方法在 Iceberg Byte Buffer Object Inspector 条件下的行为是否符合预期。
   */
  @Test
