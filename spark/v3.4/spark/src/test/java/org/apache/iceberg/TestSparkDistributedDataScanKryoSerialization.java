...
/**
 * 文件级说明：测试 TestSparkDistributedDataScanKryoSerialization 相关功能。
 *
 * <p>所属模块：iceberg-spark（spark v3.4）。职责：验证 Iceberg 表在 Spark 引擎下 Sparkdistributed数据扫描Kryo序列化
 * 相关行为，覆盖正常路径与边界场景。
 *
