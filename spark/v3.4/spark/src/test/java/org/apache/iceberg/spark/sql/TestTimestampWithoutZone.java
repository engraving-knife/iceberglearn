...
public class TestTimestampWithoutZone extends SparkCatalogTestBase {
  ...
  /** 测试deprecatedtimezone属性场景：验证该方法在对应输入下的行为与断言结果。 */
  @Test
  ...
  /** 测试读带deprecatedtimezone属性场景：验证该方法在对应输入下的行为与断言结果。 */
  @Test
  ...
  /** 测试读带deprecatedtimezone属性读选项场景：验证该方法在对应输入下的行为与断言结果。 */
  @Test
  ...
  /** 测试写带deprecatedtimezone属性场景：验证该方法在对应输入下的行为与断言结果。 */
  @Test
  ...
  /** 测试写带deprecatedtimezone属性读选项场景：验证该方法在对应输入下的行为与断言结果。 */
  @Test
  ...
  /** 测试追加时间戳带时区场景：验证该方法在对应输入下的行为与断言结果。 */
  @Test
