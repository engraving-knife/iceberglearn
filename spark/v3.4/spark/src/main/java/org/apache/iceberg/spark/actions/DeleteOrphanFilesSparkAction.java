 ...
 *
 * <p>职责：删除孤儿文件的 Spark 动作，扫描并删除表元数据不再引用的数据文件。
 *
 * <p>设计意图：通过比对文件系统实际文件与快照引用集合，识别并删除孤儿文件以回收空间。
 *
 * <p>上下游关系：由 SparkActions 创建；依赖 SparkTableUtil 进行文件列举。
 */
