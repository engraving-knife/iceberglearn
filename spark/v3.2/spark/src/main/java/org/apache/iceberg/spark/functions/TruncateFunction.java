 ...
 *
 * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateFunction。
 *
...
public class TruncateFunction implements UnboundFunction {
   ...
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateBase。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateTinyInt。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateSmallInt。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateInt。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateBigInt。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateString。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateBinary。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
   ...
   * Iceberg 内置函数在 Spark 中的实现。
   *
   * <p>所属模块：iceberg-spark v3.2。 类型：类 TruncateDecimal。
   *
   * <p>上下游：由 SparkCatalog 注册为函数，被 Spark SQL 表达式调用。
   */
