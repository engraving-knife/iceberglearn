...
/**
 * 文件级说明：IcebergSourceNestedListParquetDataWriteBenchmark 性能基准测试。
 *
 * <p>所属模块：iceberg-spark（v3.2）。职责：对 Iceberg数据源嵌套列表Parquet数据写入 相关读写操作进行 JMH 性能基准测试， 衡量吞吐与单次执行延迟等性能指标。
 *
