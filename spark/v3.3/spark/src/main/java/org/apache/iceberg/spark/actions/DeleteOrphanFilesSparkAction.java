 ...
 *
 * <p>所属模块：iceberg-spark v3.3。 类型：类 DeleteOrphanFilesSparkAction。
 *
...
public class DeleteOrphanFilesSparkAction extends BaseSparkAction<DeleteOrphanFilesSparkAction>
   ...
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 ListDirsRecursively。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
   ...
   * 基于 Spark 执行的 Iceberg 表维护动作。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 FindOrphanFiles。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
   ...
   * 基于 Spark 执行的 Iceberg 表维护动作。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 StringToFileURI。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
  @VisibleForTesting
   ...
   * 基于 Spark 执行的 Iceberg 表维护动作。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 FileInfoToFileURI。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
  @VisibleForTesting
   ...
   * 基于 Spark 执行的 Iceberg 表维护动作。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 ToFileURI。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
   ...
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 PartitionAwareHiddenPathFilter。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
  @VisibleForTesting
   ...
   * 基于 Spark 执行的 Iceberg 表维护动作。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 FileURI。
   *
   * <p>上下游：由 SparkActions 创建，委托 Spark 作业执行实际数据处理。
   */
