 ...
 *
 * <p>所属模块：iceberg-spark v3.3。 类型：类 SparkConfParser。
 */
class SparkConfParser {
   ...
   * Iceberg Spark 集成相关组件，扩展 Spark SQL 解析能力。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 BooleanConfParser。
   */
   ...
   * Iceberg Spark 集成相关组件，扩展 Spark SQL 解析能力。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 IntConfParser。
   */
   ...
   * Iceberg Spark 集成相关组件，扩展 Spark SQL 解析能力。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 LongConfParser。
   */
   ...
   * Iceberg Spark 集成相关组件，扩展 Spark SQL 解析能力。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 StringConfParser。
   */
   ...
   * Iceberg Spark 集成相关组件，扩展 Spark SQL 解析能力。
   *
   * <p>所属模块：iceberg-spark v3.3。 类型：类 ConfParser。
   */
