...
/**
 * 测试类：TestViewRepresentationParser，用于验证 View Representation Parser 相关功能。
 *
 * <p>所属模块：iceberg-core（测试目录 src/test）。 职责：针对 View Representation Parser
...
public class TestViewRepresentationParser {
  ...
  /**
   * 测试场景：parse unknown view representation。
   *
  ...
  /**
   * 测试场景：view representation missing type。
   *
   * <p>验证逻辑：针对该场景调用被测方法，断言返回结果或表/快照状态符合预期。
   */
  @Test
