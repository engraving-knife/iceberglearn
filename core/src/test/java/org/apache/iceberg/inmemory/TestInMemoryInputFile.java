...
/**
 * 测试类：TestInMemoryInputFile，用于验证 In Memory Input File 相关功能。
 *
 * <p>所属模块：iceberg-core（测试目录 src/test）。 职责：针对 In Memory Input File 的核心行为构造多种场景，覆盖正常路径、边界条件与异常输入，
 * 确保实现与预期语义一致。
 *
