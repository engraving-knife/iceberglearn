...
/**
 * 测试类：TestOAuth2Util，用于验证 O Auth 2 Util 相关功能。
 *
 * <p>所属模块：iceberg-core（测试目录 src/test）。 职责：针对 O Auth 2 Util 的核心行为构造多种场景，覆盖正常路径、边界条件与异常输入，
 * 确保实现与预期语义一致。
 *
...
public class TestOAuth2Util {
  /**
   * 测试场景：o auth scope token validation。
   *
