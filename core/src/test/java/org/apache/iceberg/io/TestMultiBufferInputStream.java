...
/**
 * 测试类：TestMultiBufferInputStream，用于验证 Multi Buffer Input Stream 相关功能。
 *
 * <p>所属模块：iceberg-core（测试目录 src/test）。 职责：针对 Multi Buffer Input Stream
